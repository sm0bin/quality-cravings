...
const Home = () => {
    ...
    return (
        <>
            ...
            {/* Banner */}
            <section className="overflow-hidden relative my-32 mx-4 md:mx-8 max-w-7xl lg:mx-auto p-12 rounded-2xl bg-cover object-right bg-[url('/banner-1.jpg')]">
                ...
                {/* <img src="/brands/banner/pepsi-1.jpg" alt="" /> */}
                <Link to="/login">
                    <button className="btn btn-neutral font-semibold bg-orange-500 hover:scale-110 hover:bg-orange-500 text-white shadow-xl border-none">Shop Now</button>
                </Link>
